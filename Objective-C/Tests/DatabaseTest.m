...
- (void) testCloseDatabaseWithActiveLiveQueries {
...
- (void) testCloseDatabaseWithActiveReplicators {
    [self openOtherDB];
...
- (void) testCloseDatabaseWithActiveLiveQueriesAndReplicators {
    [self openOtherDB];
      ...
      stoppedExpectation: (XCTestExpectation*)stopedExp
{
    [repl addChangeListener: ^(CBLReplicatorChange* change) {
        ...
        if (change.status.activity == kCBLReplicatorStopped) { [stopedExp fulfill]; }
    }];
...
- (void) testDeleteDatabaseWithActiveLiveQueries {
    XCTestExpectation* change1 = [self expectationWithDescription: @"changes 1"];
    XCTestExpectation* change2 = [self expectationWithDescription: @"changes 2"];
...
- (void) __testDeleteDatabaseWithActiveReplicators {
    [self openOtherDB];
...
- (void) __testDeleteDatabaseWithActiveLiveQueriesAndReplicators {
    [self openOtherDB];
